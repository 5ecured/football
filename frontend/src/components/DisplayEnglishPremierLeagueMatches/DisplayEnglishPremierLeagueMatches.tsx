...
const DisplayEnglishPremierLeagueMatches: React.FC = () => {
    const classes = useStyles()
    const data = useSelector((state: RootState) => state.englishPremierLeague.data)
...
export default DisplayEnglishPremierLeagueMatches